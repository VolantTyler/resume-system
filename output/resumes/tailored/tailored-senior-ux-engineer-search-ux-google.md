...
**Front-End Engineer — tailored for Senior UX Engineer, Search UX - Google**
...
Front-end software engineer focused on accessible UI implementation, practical testing, and maintainable web applications across React, TypeScript, and Laravel/Livewire stacks.
...
- Built client-facing web experiences with JavaScript, PHP, and HTML/CSS, including SEO support.
...
- Translated agency designs into production frontend for a high-traffic nonprofit platform rebuild.
- Collaborated with marketing leadership to ship schedule-driven website features alongside major rebrand initiatives.
- Supported frontend and full-stack initiatives tied to major grant and processing-efficiency outcomes.
