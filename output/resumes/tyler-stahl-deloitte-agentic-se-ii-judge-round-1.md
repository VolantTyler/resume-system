...
**Source:** `resume_targets.yaml#agentic-software-engineer`
**Job title:** Agentic Software Engineer
**Résumé version:** `tyler-stahl-deloitte-agentic-se-ii`
**Round:** 1
**Model:** `stub`
...
|-----------|-------|----------|
| relevance | 5/10 | Selected accomplishments share themes/technologies with the JD (1 overlapping). |
