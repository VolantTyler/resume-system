...
**Source:** `resume_targets.yaml#agentic-ai-engineer`
**Job title:** Agentic AI Engineer
**Résumé version:** `tyler-stahl-deloitte-agentic-ai`
**Round:** 1
**Model:** `stub`
...
|-----------|-------|----------|
| relevance | 10/10 | Selected accomplishments share themes/technologies with the JD (13 overlapping). |
