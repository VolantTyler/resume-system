...
**Source:** `resume_targets.yaml#applied-ai-developer`
**Job title:** Applied AI Developer
...
|-----------|-------|----------|
| relevance | 10/10 | Selected accomplishments share themes/technologies with the JD (10 overlapping). |
